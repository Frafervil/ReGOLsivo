...
<p>La presente Política de Privacidad establece los términos en que
	ReGOLsivo usa y protege la información que es proporcionada por sus
...
<p>ReGOLsivo está altamente comprometido para cumplir con el
...
<p>ReGOLsivo se reserva el derecho de cambiar los términos de la
	presente Política de Privacidad en cualquier momento.</p>
    <div class="">
    <b-button type="submit" class="btn-large-space" :to="{ name: 'CreateUsuario'}">Atrás</b-button>
    </div>
  </div>
</template>
